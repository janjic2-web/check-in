...
class CheckinAntiSpamTest extends TestCase
{
    use RefreshDatabase;
    ...
    public function test_checkin_antispam_blocked()
    {
        ...
        // Drugi checkin odmah nakon prvog treba da bude blokiran (antispam)
